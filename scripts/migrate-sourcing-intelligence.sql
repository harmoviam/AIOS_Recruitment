...
-- V1 schema (Node / Express) — Version 2.0 / Sprint 1
-- Applied at runtime by: server/src/migrations/sourcingIntelligence.ts
--   via migrateSourcingIntelligence() in server/src/db.ts
...
-- All tables are tenant-scoped (tenant_id).
-- =============================================================================
